...
def faculty_edit(request,pk):
    ...
    if request.POST and form.is_valid():
        ...
        actions = request.session.get('actions', [])
        actions += [f"You edit faculty: {request.POST.get('name')}"]
        request.session["actions"] = actions
        return redirect('faculty_list')
...
def subject_create(request):
    ...
    if request.POST and form.is_valid():
        form.save()
        actions = request.session.get('actions', [])
        actions += [f"You added subject: {request.POST.get('name')}"]
        request.session["actions"] = actions
...
def group_create(request):
    ...
    if request.POST and form.is_valid():
        form.save()
        actions = request.session.get('actions', [])
        actions += [f"You added group: {request.POST.get('first_name')}"]
        request.session["actions"] = actions
...
def group_edit(request,pk):
    ...
    if request.POST and form.is_valid():
        form.save()
        actions = request.session.get('actions', [])
        actions += [f"You edit group: {request.POST.get('first_name')}"]
        request.session["actions"] = actions
        return redirect('group_list')
    ctx = {
        "model":model,
...
def student_create(request):
    ...
    if request.POST and form.is_valid():
        form.save()
        actions = request.session.get('actions', [])
        actions += [f"You added student: {request.POST.get('first_name')}"]
        request.session["actions"] = actions
...
def student_edit(request,pk):
    ...
    if request.POST and form.is_valid():
        form.save()
        actions = request.session.get('actions', [])
        actions += [f"You edit student: {request.POST.get('first_name')}"]
        request.session["actions"] = actions
        return redirect('student_list')
    ctx = {
        "model":model,
